public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Thread- Lifecycles (NEW -> ,RUNNABLE <->, RUNNING, -> DEAD)
        ...
        // A dead Thread can not be executed twice (for example be calling start() again later on), it will throw a IllegalStateException
